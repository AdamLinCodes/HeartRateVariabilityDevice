...
#include "../HeartRateVariabilityDevice/Button.h"
...
QT_MOC_LITERAL(1, 7, 16), // "clickedWithCount"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "count"
QT_MOC_LITERAL(4, 31, 15) // "onButtonClicked"

    },
    "Button\0clickedWithCount\0\0count\0"
    "onButtonClicked"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickedWithCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::clickedWithCount)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Button::clickedWithCount(int _t1)
{
